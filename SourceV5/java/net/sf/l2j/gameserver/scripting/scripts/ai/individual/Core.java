	...
	public Core()
	{
		...
		if (status == DEAD)
		{
			...
			else
			{
				...
				{
					Broadcast.gameAnnounceToOnlinePlayers("Epic Boss: " + core.getName() + " spawned in world.");
				}
			}
		}
		else
		{
			...
			final GrandBoss core = (GrandBoss) addSpawn(CORE, 17726, 108915, -6500, 0, false, 0,false);
