...
public final class Config
{
	...
	public static int VISUAL_LEGS1;
	public static int VISUAL_GLOVES1;
	public static int VISUAL_BOOTS1;
	public static String VISUAL_NAME1;
	
	public static int VISUAL_HAIR2;
	public static int VISUAL_CHEST2;
	public static int VISUAL_LEGS2;
	public static int VISUAL_GLOVES2;
	public static int VISUAL_BOOTS2;
	...
	public static int VISUAL_HAIR22;
	public static int VISUAL_CHEST22;
	public static int VISUAL_LEGS22;
	public static int VISUAL_GLOVES22;
	public static int VISUAL_BOOTS22;
	public static String VISUAL_NAME22;
	
	public static int VISUAL_HAIR23;
	public static int VISUAL_CHEST23;
	public static int VISUAL_LEGS23;
	public static int VISUAL_GLOVES23;
	public static int VISUAL_BOOTS23;
	public static String VISUAL_NAME23;
	
	public static int VISUAL_HAIR24;
	public static int VISUAL_CHEST24;
	public static int VISUAL_LEGS24;
	public static int VISUAL_GLOVES24;
	public static int VISUAL_BOOTS24;
	public static String VISUAL_NAME24;
	
	public static int VISUAL_HAIR25;
	public static int VISUAL_CHEST25;
	public static int VISUAL_LEGS25;
	public static int VISUAL_GLOVES25;
	public static int VISUAL_BOOTS25;
	public static String VISUAL_NAME25;
	
	public static int VISUAL_HAIR26;
	public static int VISUAL_CHEST26;
	public static int VISUAL_LEGS26;
	public static int VISUAL_GLOVES26;
	public static int VISUAL_BOOTS26;
	public static String VISUAL_NAME26;
	
	public static int VISUAL_HAIR27;
	public static int VISUAL_CHEST27;
	public static int VISUAL_LEGS27;
	public static int VISUAL_GLOVES27;
	public static int VISUAL_BOOTS27;
	public static String VISUAL_NAME27;
	
	public static int VISUAL_HAIR28;
	public static int VISUAL_CHEST28;
	public static int VISUAL_LEGS28;
	public static int VISUAL_GLOVES28;
	public static int VISUAL_BOOTS28;
	public static String VISUAL_NAME28;
	
	public static int VISUAL_HAIR29;
	public static int VISUAL_CHEST29;
	public static int VISUAL_LEGS29;
	public static int VISUAL_GLOVES29;
	public static int VISUAL_BOOTS29;
	public static String VISUAL_NAME29;
	...
	public static final String PARTY_FILE = "./config/customs/Events/PartyFarm.properties";
	...
	public static final String VISUAL_FILE = "./config/aCis/Visual.properties";
	public static final String PCBANGPOINT_FILE = "./config/aCis/PcBanG.properties";
	...
	private static final void loadRaidboss()
	{
		...
		ANNOUNCE_RB_SPAWN = npcs.getProperty("AnnounceRbSpawn", false);
		ANNOUNCE_DEAD_RB = npcs.getProperty("AnnounceDeadRb", false);
		GRAND_BOSS_ANNOUNCE = npcs.getProperty("AnnounceGrandBossStatus", false);
	...
	private static final void loadPtfarm()
	{
		...
		CHANCE_PARTY_DROP = Integer.parseInt(BestFarm.getProperty("ChanceForDrops", "20"));
		...
		String PARTY_DROP_REWARD_VALUE = BestFarm.getProperty("PartyDropReward", "57,100000000;");
	...
	{
		final ExProperties Visual = initProperties(Config.VISUAL_FILE);
		
		ENABLE_VISUAL_SET = Visual.getProperty("EnableVisual", false);
		ENABLE_VISUAL_EFFECT = Visual.getProperty("EnableEffect", false);
		...
		VISUAL_CHEST1 = Visual.getProperty("VisualChest1", 9400);
		VISUAL_LEGS1 = Visual.getProperty("VisualLegs1", 00);
		VISUAL_GLOVES1 = Visual.getProperty("VisualGloves1", 00);
		VISUAL_BOOTS1 = Visual.getProperty("VisualBoots1", 00);
		...
		VISUAL_LEGS2 = Visual.getProperty("VisualLegs2", 00);
		VISUAL_GLOVES2 = Visual.getProperty("VisualGloves2", 00);
		VISUAL_BOOTS2 = Visual.getProperty("VisualBoots2", 00);
		...
		VISUAL_HAIR22 = Visual.getProperty("VisualHair22", 6842);
		VISUAL_CHEST22 = Visual.getProperty("VisualChest22", 9400);
		VISUAL_LEGS22 = Visual.getProperty("VisualLegs22", 00);
		VISUAL_GLOVES22 = Visual.getProperty("VisualGloves22", 00);
		VISUAL_BOOTS22 = Visual.getProperty("VisualBoots22", 00);
		VISUAL_NAME22 = Visual.getProperty("VisualName22", "Jappan");
		
		VISUAL_HAIR23 = Visual.getProperty("VisualHair23", 6842);
		VISUAL_CHEST23 = Visual.getProperty("VisualChest23", 9400);
		VISUAL_LEGS23 = Visual.getProperty("VisualLegs23", 00);
		VISUAL_GLOVES23 = Visual.getProperty("VisualGloves23", 00);
		VISUAL_BOOTS23 = Visual.getProperty("VisualBoots23", 00);
		VISUAL_NAME23 = Visual.getProperty("VisualName23", "Jappan");
		
		VISUAL_HAIR24 = Visual.getProperty("VisualHair24", 6842);
		VISUAL_CHEST24 = Visual.getProperty("VisualChest24", 9400);
		VISUAL_LEGS24 = Visual.getProperty("VisualLegs24", 00);
		VISUAL_GLOVES24 = Visual.getProperty("VisualGloves24", 00);
		VISUAL_BOOTS24 = Visual.getProperty("VisualBoots24", 00);
		VISUAL_NAME24 = Visual.getProperty("VisualName24", "Jappan");
		
		VISUAL_HAIR25 = Visual.getProperty("VisualHair25", 6842);
		VISUAL_CHEST25 = Visual.getProperty("VisualChest25", 9400);
		VISUAL_LEGS25 = Visual.getProperty("VisualLegs25", 00);
		VISUAL_GLOVES25 = Visual.getProperty("VisualGloves25", 00);
		VISUAL_BOOTS25 = Visual.getProperty("VisualBoots25", 00);
		VISUAL_NAME25 = Visual.getProperty("VisualName25", "Jappan");
		
		VISUAL_HAIR26 = Visual.getProperty("VisualHair26", 6842);
		VISUAL_CHEST26 = Visual.getProperty("VisualChest26", 9400);
		VISUAL_LEGS26 = Visual.getProperty("VisualLegs26", 00);
		VISUAL_GLOVES26 = Visual.getProperty("VisualGloves26", 00);
		VISUAL_BOOTS26 = Visual.getProperty("VisualBoots26", 00);
		VISUAL_NAME26 = Visual.getProperty("VisualName26", "Jappan");
		
		VISUAL_HAIR27 = Visual.getProperty("VisualHair27", 6842);
		VISUAL_CHEST27 = Visual.getProperty("VisualChest27", 9400);
		VISUAL_LEGS27 = Visual.getProperty("VisualLegs27", 00);
		VISUAL_GLOVES27 = Visual.getProperty("VisualGloves27", 00);
		VISUAL_BOOTS27 = Visual.getProperty("VisualBoots27", 00);
		VISUAL_NAME27 = Visual.getProperty("VisualName27", "Jappan");
		
		VISUAL_HAIR28 = Visual.getProperty("VisualHair28", 6842);
		VISUAL_CHEST28 = Visual.getProperty("VisualChest28", 9400);
		VISUAL_LEGS28 = Visual.getProperty("VisualLegs28", 00);
		VISUAL_GLOVES28 = Visual.getProperty("VisualGloves28", 00);
		VISUAL_BOOTS28 = Visual.getProperty("VisualBoots28", 00);
		VISUAL_NAME28 = Visual.getProperty("VisualName28", "Jappan");
		
		VISUAL_HAIR29 = Visual.getProperty("VisualHair29", 6842);
		VISUAL_CHEST29 = Visual.getProperty("VisualChest29", 9400);
		VISUAL_LEGS29 = Visual.getProperty("VisualLegs29", 00);
		VISUAL_GLOVES29 = Visual.getProperty("VisualGloves29", 00);
		VISUAL_BOOTS29 = Visual.getProperty("VisualBoots29", 00);
		VISUAL_NAME29 = Visual.getProperty("VisualName29", "Jappan");
		
		CAMERA_ENABLED = Visual.getProperty("CameraEnabled", false);
