...
import net.sf.l2j.gameserver.handler.itemhandlers.VipItem2;
import net.sf.l2j.gameserver.handler.itemhandlers.VipItem3;
import net.sf.l2j.gameserver.handler.itemhandlers.Visual;
...
public class ItemHandler
{
	...
	protected ItemHandler()
	{
		...
		registerItemHandler(new VipItem3());
		registerItemHandler(new VipItem2());
		...
		registerItemHandler(new Visual());
