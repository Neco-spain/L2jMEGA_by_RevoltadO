...
{
	private static final int ITEM_IDS[] = { Config.VIP_ITEM2 };
 ...
 public synchronized void useItem(Playable playable,
	 ItemInstance item,boolean forceUse) {
		 ...
		 else
		 {
			    ...
			    player.sendMessage("You became a VIP, you will have " +"Access privileges Npcs Vips, Your  Vip Last "+Config.VIP_DIAS2+" Days.");
