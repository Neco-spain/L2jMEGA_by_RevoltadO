...
public class Sailren extends L2AttackableAIScript
{
	...
	public Sailren()
	{
		...
		switch (GrandBossManager.getInstance().getBossStatus(SAILREN))
		{
			...
			case FIGHTING:
				...
				{
					Broadcast.gameAnnounceToOnlinePlayers("Epic Boss: " + sailren.getName() + " spawned in world.");
				}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		...
		else if (event.equalsIgnoreCase("camera_4"))
		{
			...
			final Npc  sailren = addSpawn(SAILREN, SAILREN_LOC, false, 0, false);
			GrandBossManager.getInstance().addBoss((GrandBoss) sailren);
			if (Config.ANNOUNCE_BOSS_ALIVE)
			{
				Broadcast.gameAnnounceToOnlinePlayers("Epic Boss: " + sailren.getName() + " spawned in world.");
			...
			sailren.broadcastPacket(new SocialAction(sailren, 2));
		}
