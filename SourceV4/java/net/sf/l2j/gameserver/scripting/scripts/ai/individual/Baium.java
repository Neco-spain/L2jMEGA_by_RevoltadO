	...
	public Baium()
	{
		...
		if (status == DEAD)
		{
			...
			else
			{
				...
				{
					Broadcast.gameAnnounceToOnlinePlayers("Epic Boss Baium Stone spawned in world.");
				}
			}
		}
		else if (status == AWAKE)
		{
			...
			if (Config.ANNOUNCE_BOSS_ALIVE)
			{
				Broadcast.gameAnnounceToOnlinePlayers("Epic Boss: " + baium.getName() + " spawned in world.");
			}
