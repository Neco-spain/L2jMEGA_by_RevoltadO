...
public class OlympiadDamageManager
{
	...
	{
		String STATUS_FILE = "./config/customs/Balancing/ClasseDamagesOly.properties";
		InputStream is = null;
		File file = null;
		try
		{
			...
			for (Object key : key_set)
			{
				...
				Integer class_id = Integer.valueOf(CharTemplateTable.getClassIdByName(class_name) - 1);
