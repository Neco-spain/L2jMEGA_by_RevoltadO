...
public class Valakas extends L2AttackableAIScript
{
	...
	public Valakas()
	{
		...
		switch (GrandBossManager.getInstance().getBossStatus(VALAKAS))
		{
			...
			case FIGHTING:
				...
				{
					Broadcast.gameAnnounceToOnlinePlayers("Epic Boss: " + valakas.getName() + " spawned in world.");
				}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		if (event.equalsIgnoreCase("beginning"))
		{
			...
			if (Config.ANNOUNCE_BOSS_ALIVE)
			{
				Broadcast.gameAnnounceToOnlinePlayers("Epic Boss: " + npc.getName() + " spawned in world.");
			}
			npc.setIsInvul(true);
