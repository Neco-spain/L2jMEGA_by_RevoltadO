...
public class AdminCreateItem implements IAdminCommandHandler
{
	...
	private static int getCoinId(String name)
	{
		...
		if (name.equalsIgnoreCase("GoldTesoure"))
			return 9302;
		
		if (name.equalsIgnoreCase("TicketShop"))
			return 9303;
		
		if (name.equalsIgnoreCase("RaidBloody"))
			return 9304;
		
		if (name.equalsIgnoreCase("SilverCoin"))
			return 9390;
		
		if (name.equalsIgnoreCase("GoldCoin"))
			return 9391;
