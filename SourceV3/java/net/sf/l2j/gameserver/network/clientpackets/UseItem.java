...
public final class UseItem extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (activeChar.isGM())
			activeChar.sendPacket(new CreatureSay(0, Say2.SHOUT, "", "{ID}  " + item.getItemId() + "   {NAME}  " + item.getItemName()));
		...
		{
			if (Config.TOURNAMENT_LISTID_RESTRICT.contains(Integer.valueOf(item.getItemId())))
			{
