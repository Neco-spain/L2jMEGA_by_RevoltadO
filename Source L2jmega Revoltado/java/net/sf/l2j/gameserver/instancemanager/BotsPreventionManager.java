 ...
 public class BotsPreventionManager
{
	...
	public void prevalidationwindow(Player player)
	{
		...
		StringUtil.append(tb, "<br><br>if such window appears it means server suspect,<br1>that you may using cheating software.");
		StringUtil.append(tb, "<br><br>if given answer results are incorrect or no action is made<br1>server is going to punish character instantly.");
	...
	private static void validationwindow(Player player)
	{
		...
		StringUtil.append(tb, "<title>Bots prevention</title>");
		StringUtil.append(tb, "<body><center><br><br><img src=\"L2UI_CH3.herotower_deco\" width=\"256\" height=\"32\">");
		StringUtil.append(tb, "<br><br>in order to prove you are a human being<br1>you've to match colours within generated pattern:");
		...
		StringUtil.append(tb, "<br><br>click-on pattern of your choice beneath:");
	...
	public void punishmentnwindow(Player player)
	{
		...
		StringUtil.append(tb, "<title>Bots prevention</title>");
		StringUtil.append(tb, "<body><center><br><br><img src=\"L2UI_CH3.herotower_deco\" width=\"256\" height=\"32\">");
		StringUtil.append(tb, "<br><br>if such window appears, it means character haven't<br1>passed through prevention system.");
		StringUtil.append(tb, "<br><br>in such case character get moved to nearest town.");
		StringUtil.append(tb, "</center></body>");
		StringUtil.append(tb, "</html>");
		html.setHtml(tb.toString());
		player.sendPacket(html);
