...
public class MultiNpc extends Folk
{
			...
			try
			{
				...
				switch (type)
				{
					...
					case "ChangeClass":
						...
						html.setFile("data/html/mods/donateNpc/20704-2.htm");
	...
	public void showChatWindow(Player player, String command)
	{
		...
		filename = "data/html/mods/donateNpc/20704-" + page + ".htm";
	...
	public void GreenColor(Player player)
	{
	...
	public void BlueColor(Player player)
	{
		if (player.getInventory().getInventoryItemCount(Config.DONATE_ITEM, -1) < Config.COLOR_ITEM_COUNT)
		{
			player.sendMessage("You do not have enough Donate Coins.");
	...
	public void PurpleColor(Player player)
	{
		if (player.getInventory().getInventoryItemCount(Config.DONATE_ITEM, -1) < Config.COLOR_ITEM_COUNT)
		{
			player.sendMessage("You do not have enough Donate Coins.");
	...
	public void YellowColor(Player player)
	{
		if (player.getInventory().getInventoryItemCount(Config.DONATE_ITEM, -1) < Config.COLOR_ITEM_COUNT)
		{
			player.sendMessage("You do not have enough Donate Coins.");
	...
	public void GoldColor(Player player)
	{
		if (player.getInventory().getInventoryItemCount(Config.DONATE_ITEM, -1) < Config.COLOR_ITEM_COUNT)
		{
			player.sendMessage("You do not have enough Donate Coins.");
	...
	public void Enchant(Player player, int enchant, int type)
	{
	...
	public void teleportToClan(String clan, Player activeChar, Player target)
	{
		if (target.getObjectId() == activeChar.getObjectId())
			activeChar.sendPacket(SystemMessageId.CANNOT_USE_ON_YOURSELF);
