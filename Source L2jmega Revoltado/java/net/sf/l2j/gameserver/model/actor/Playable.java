...
public abstract class Playable extends Creature
{
	...
	public boolean doDie(Creature killer)
	{
		...
		else if ((Config.LEAVE_BUFFS_ON_DIE) || ((isInsideZone(ZoneId.FLAG)) && (!isInsideZone(ZoneId.CUSTOM)) && (!isArena2x2())) || ((isArenaAttack()) && ((isArena9x9()) || ((isArena4x4()) && (Config.ALLOW_4X4_LOSTBUFF)))))
		{
